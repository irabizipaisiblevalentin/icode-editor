...
/**
 * Map a iCode {@link LogLevel} onto the corresponding OTLP
...
/**
 * Map a iCode {@link LogLevel} onto the matching OTLP level name used in
...
/**
 * Reverse of {@link logLevelToOtlpSeverity}: returns the closest iCode

...
export type RemoteAgentHostConnectionStatus =
	...
	| {
		 ...
		 * Set only when the server was spawned by a iCode CLI willing
...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * client connects to, and is used to construct the iCode Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the iCode Remote Tunnels authority

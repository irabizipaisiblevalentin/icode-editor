...
/** iCode-owned request metadata indicating a throwaway chat surface. */
...
/** Typed view over iCode's ephemeral-session request metadata. */
...
/** Adds iCode's ephemeral-session metadata to an open request metadata bag. */

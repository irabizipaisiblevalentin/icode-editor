...
/** The metadata key for iCode-owned chat-surface information. */
...
/** iCode-owned metadata describing the chat surface that created a session. */
...
/** Adds iCode's typed chat-surface metadata to an open request metadata bag. */

 ...
 * by the iCode CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the iCode CLI populate this
 ...
 * extension used by iCode-hosted agent hosts.
 *

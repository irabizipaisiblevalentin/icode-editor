 ...
 * Copilot SDK event log from iCode turns.
 */
...
/**
 * Translates a sequence of iCode {@link Turn}s into a Copilot SDK
 ...
 * {@link serializeSessionEventsToJsonl}: turns the given iCode turns directly

...
type CopilotClientOperationFailureClassification = IAgentHostEventClassification & {
	...
	msg: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The client failure message. iCode telemetry scrubs file paths and likely secrets before transmission.' };
	callstack: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The client failure stack. iCode telemetry scrubs file paths and likely secrets before transmission.' };
	owner: 'roblourens';
...
type CopilotSdkSessionErrorClassification = IAgentHostEventClassification & {
	...
	msg: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The SDK session error message. iCode telemetry scrubs file paths and likely secrets before transmission.' };
	callstack: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The SDK session error stack. iCode telemetry scrubs file paths and likely secrets before transmission.' };
	owner: 'roblourens';

...
export async function buildOptions(
	...
	const settingsEnv: Record<string, string> = {
		...
		// Attribute the CLI's tool subprocesses (`gh`, …) to iCode.
		...
		// tool, so commands from that tool are not attributed to iCode.
 ...
 * proxied env still announces the originating iCode surface. Mirror of the

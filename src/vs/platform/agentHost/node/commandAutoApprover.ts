...
export interface IShouldAutoApproveOptions {
	...
	/**
	 * Effective iCode `chat.tools.terminal.autoApprove` rules forwarded from
 ...
 * The rules are normally forwarded from iCode's
...
// ---- Default rules ----------------------------------------------------------
//
// Compatibility fallback for clients that do not forward the iCode

 ...
 *
 * Like [iCode resources], path operations use `/` URI separators on every
 ...
 *
 * [iCode resources]: https://github.com/microsoft/vscode/blob/main/src/vs/base/common/resources.ts
 */

...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* iCode injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* iCode injected style */ * { cursor: crosshair !important; }';

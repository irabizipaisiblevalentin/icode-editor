...
export enum Filters {
	...
	/**
	 * The platform (OS) on which iCode is running.
	 */
	Platform = 'X-VSCode-Platform',

	/**
	 * The release/build date of iCode (UTC) in the format yyyymmddHH.
	 */
	ReleaseDate = 'X-VSCode-ReleaseDate',

	/**
	 * The kind of window iCode is running in (`editor` or `agents`).
	 */
...
/**
 * Emits the generic iCode core filters for the new TAS assignments API using the new

...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often iCode updates have failed.';
};
...
export abstract class AbstractUpdateService extends Disposable implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when iCode detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of iCode.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of iCode.' };

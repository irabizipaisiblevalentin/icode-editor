...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit iCode's "shell environment" that may
	 ...
	 * a terminal used to drive some iCode feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to iCode and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** iCode shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}

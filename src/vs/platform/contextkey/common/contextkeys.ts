...
import { isIOS, isLinux, isMacintosh, isMobile, isWeb, isWindows, isChromeOS } from '../../../base/common/platform.js';
...
export const IsChromeOSContext = new RawContextKey<boolean>('isChromeOS', isChromeOS, localize('isChromeOS', "Whether the operating system is ChromeOS"));
...
export const ProductQualityContext = new RawContextKey<string>('productQualityType', '', localize('productQualityType', "Quality type of iCode"));

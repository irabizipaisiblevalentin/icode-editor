...
/**
 * Service that tracks whether the user is actively paying attention to iCode.
 *
 * This is determined by:
 * * iCode window has focus
...
export interface IUserAttentionService {
	 ...
	 * This includes keyboard typing and mouse movements/clicks while iCode is focused.
	 * The 500ms window prevents event spam from continuous mouse movement.
	 */
	readonly isUserActive: IObservable<boolean>;

	/**
	 * Observable that indicates whether the user is actively paying attention to iCode.
	 * This is true when:
	 * * iCode has focus, AND
	...
	/**
	 * The total time in milliseconds that the user has been paying attention to iCode.
	 */

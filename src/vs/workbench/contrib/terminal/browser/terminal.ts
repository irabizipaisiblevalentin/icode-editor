 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in iCode UI).
 */
 ...
 * to represent terminals that appear in other parts of the iCode UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their iCode OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given iCode log level.
	 */
	updateLogLevel(): void;

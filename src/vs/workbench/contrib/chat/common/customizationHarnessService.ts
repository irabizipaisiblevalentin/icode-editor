 ...
 *
 * The default (core) registration exposes a single "iCode" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * iCode harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default iCode harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
...
/**
 * Creates a "iCode" harness descriptor that shows all storage sources

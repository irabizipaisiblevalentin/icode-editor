...
/**
 * Builds a redirect URL that GitHub will use to return the user to iCode
 ...
 * @param urlProtocol The iCode URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).

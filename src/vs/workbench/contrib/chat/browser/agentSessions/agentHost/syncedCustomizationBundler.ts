...
const DISPLAY_NAME = 'iCode Synced Data';
...
const MANIFEST_CONTENT = JSON.stringify({
	name: DISPLAY_NAME,
	description: 'Customization data synced from iCode',
}, null, '\t');
...
/**
 * An MCP server configured directly in iCode (i.e. not contributed by an
 ...
 * ```
 * .plugin/plugin.json
 * .mcp.json        ← MCP servers configured in iCode

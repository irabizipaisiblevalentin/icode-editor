 ...
 * and in the regular iCode workbench window it returns nothing at all.
 */
 ...
 * any per-provider plumbing. In the regular iCode workbench window the
...
/**
 * Enumerates MCP servers configured directly in iCode — i.e. those that
 ...
 * iCode — are bundled into a synthetic Open Plugin.
 */

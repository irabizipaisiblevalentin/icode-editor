...
export interface IModelPickerUnavailableEntry {
	...
	/** The model exists for this account but needs a newer iCode. */
...
export interface IModelPickerSectionsOptions {
	...
	/** This build's version, used to spot models gated behind a newer iCode. */
...
/** Whether the entry names a minimum iCode version this build does not meet. */

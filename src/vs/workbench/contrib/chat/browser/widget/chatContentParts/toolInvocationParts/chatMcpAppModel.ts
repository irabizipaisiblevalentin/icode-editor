...
export class ChatMcpAppModel extends Disposable {
	 ...
	 * iCode restarts — using {@link WebviewOriginStore} for them would
		...
		try {
			...
			switch (request.method) {
				...
				case 'ui/request-display-mode':
					// iCode only supports inline display mode
	 ...
	 * server-definition id is stable across iCode restarts. Agent-host

...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in iCode in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open iCode and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,

...
/** Returns the collection provenance represented by a iCode configuration target. */
...
/**
 * A representation of an MCP resource. The `uri` is namespaced to iCode and
 * can be used in filesystem APIs.
 */
export interface IMcpResource {
	/** Identifier for the file in iCode and operable with filesystem API */
	readonly uri: URI;
...
export interface IMcpWorkbenchService {
	...
	/** Returns enabled iCode-format servers after name precedence; root files are discovered independently. */

...
type FirstTimeWindowOpenClassification = {
	...
	workspaceHistoryState: { classification: 'SystemMetaData'; purpose: 'PerformanceAndHealth'; comment: 'iCode recent-folder history lookup state at capture: loading, loaded, or error. Loaded means a lookup completed, not that every provider is ready.' };

...
// Mirrors iCode's "Focus Editor Group N": Ctrl/Cmd+1..8 focus that grid slot
	...
	constructor() {
		super({
			...
			keybinding: {
				...
				// nothing was closed); inside it, iCode's own Reopen Closed
				// Editor takes over.
